...
const NAV_ICONS = {
  ...
  "crm":            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>,
          ...
          <div className="content">
            {loading ? (
              ...
              <>
                ...
                {page==="crm"&&<CRM token={auth.token} userId={auth.user.id} profile={profile} setContacts={setContacts} setPage={setPage} />}
