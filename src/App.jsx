          ...
          <div className="content">
            {loading ? (
              ...
              <>
                ...
                {page==="admin-reports"&&<AdminReports invoices={invoices} products={products} contacts={contacts} accounts={accounts} allProfiles={allProfiles} setPage={setPage} setPendingFilter={setPendingFilter} token={auth.token} />}
