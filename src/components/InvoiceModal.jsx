...
export function InvoiceModal({ invoice, onClose, contacts = [], onStatusChange, onDuplicate, onEdit, onPartPay, onLogPartPay, token, profile }) {
  ...
  const handlePrint = async (asReceipt = false) => {
    ...
    const isRct = asReceipt === true || String(invoice.invoice_number || '').startsWith('RCT-');
    const paidAmt = invoice.status === 'paid' ? tot : parseFloat(invoice.amount_paid || 0);
      ...
      <div className="modal" style={{ maxWidth: 980 }}>
          ...
          <div className="inv-doc">
            <div className="inv-header">
              ...
              <div className="inv-title-block">
                <div className="inv-title">{String(invoice.invoice_number||"").startsWith("RCT-") ? "RECEIPT" : "INVOICE"}</div>
                <div style={{ marginTop: 8 }}><span className={"badge " + sc.cls}>{sc.label}</span></div>
              </div>
            </div>
            <div className="inv-meta">
              <div>
                <div className="inv-meta-lbl">{String(invoice.invoice_number||"").startsWith("RCT-") ? "Receipt for" : "Invoice to"}</div>
                <div className="inv-meta-val" style={{ fontSize: 17, marginBottom: 4 }}>{invoice.customer}</div>
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
                <div><div className="inv-meta-lbl">{String(invoice.invoice_number||"").startsWith("RCT-") ? "Receipt #" : "Invoice #"}</div><div className="inv-meta-val">{invoice.invoice_number}</div></div>
        ...
        {activeTab === "actions" && (
          <div style={{ padding: "28px 32px" }}>
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <div className="inv-action-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: 10 }}>
                {[
                  { label: "Print Invoice", color: "#dd2b0f", bg: "rgba(221,43,15,.10)", onClick: () => handlePrint(false),
                  ...
                  { label: "Print Receipt", color: "#166534", bg: "#f0fdf4", onClick: () => handlePrint(true),
                    svg: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#166534" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1-2-1z"/><line x1="8" y1="8" x2="16" y2="8"/><line x1="8" y1="12" x2="16" y2="12"/><line x1="8" y1="16" x2="12" y2="16"/></svg> },
        ...
        <div className="inv-side">
          ...
          <div className="inv-side-actions" style={{ display: "flex", gap: 8 }}>
            <button className="btn bo bsm" onClick={() => handlePrint(false)} style={{ flex: 1, justifyContent: "center" }} title="Print Invoice"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect x="6" y="14" width="12" height="8"/></svg></button><button className="btn bo bsm" onClick={() => handlePrint(true)} style={{ flex: 1, justifyContent: "center", color: "#166534", borderColor: "#86efac" }} title="Print Receipt"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1-2-1z"/><line x1="8" y1="8" x2="16" y2="8"/><line x1="8" y1="12" x2="16" y2="12"/></svg></button>
        ...
        <div className="modal-actions">
          <div style={{ display: "flex", gap: 8, flex: 1, justifyContent: "space-between", alignItems: "center", flexWrap: "wrap" }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              ...
              <button className="btn bo bsm" onClick={() => handlePrint(true)} style={{ color: "#166534", borderColor: "#166534" }}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1-2-1z"/><line x1="8" y1="8" x2="16" y2="8"/><line x1="8" y1="12" x2="16" y2="12"/></svg>Receipt</button><button className="btn bp bsm" onClick={() => handlePrint(false)}><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect x="6" y="14" width="12" height="8"/></svg>Print</button>
            </div>
          </div>
      </div>
    </div>
